...
var render = function() {
  ...
  return _c("layout", { attrs: { title: "Beranda" } }, [
    _c(
      "div",
      { staticClass: "flex justify-between mx-auto w-3/6" },
      [
        _c(
          "inertia-link",
          {
          ...
          [
            _c("img", {
              ...
              staticStyle: { width: "120px", height: "180px" },
              attrs: { src: "/img/login.png", alt: "Masuk" }
            }),
            _vm._v(" "),
            _c("p", [_vm._v("Masuk")])
          ]
        ...
        _c(
          ...
          [
            _c("img", {
              staticClass: "max-w-full",
              staticStyle: { width: "120px", height: "180px" },
              attrs: { src: "/img/register.png", alt: "Daftar" }
            }),
            _vm._v(" "),
            _c("p", [_vm._v("Daftar")])
          ]
        ...
        _c(
          "inertia-link",
          {
            staticClass: "text-center",
            staticStyle: { width: "120px" },
            attrs: { href: "/lapor-datang" }
          },
          [
            _c("img", {
              staticClass: "max-w-full",
              staticStyle: { width: "120px", height: "180px" },
              attrs: { src: "/img/report.png", alt: "Lapor Datang" }
            }),
            _vm._v(" "),
            _c("p", [_vm._v("Lapor Datang")])
          ]
        ),
        _vm._v(" "),
        _c(
          ...
          [
            _c("img", {
              ...
              staticStyle: { width: "120px", height: "180px" },
              attrs: {
                src: "/img/permohonan.png",
                alt: "Permohonan Cetak SKTT"
              }
            }),
            _vm._v(" "),
            _c("p", [_vm._v("Permohonan Cetak SKTT")])
          ]
        )
      ],
      1
    ...
    _c("div", { staticClass: "w-4/6" }, [
      _c("h4", { staticClass: "font-bold underline text-xl mb-3" }, [
        _vm._v("Informasi")
      ]),
      _vm._v(" "),
      _c("p", [_vm._v("Silakan pilih masuk (jika sudah pernah daftar).")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "Jika belum, silakan pilih daftar (pastikan anda mengisi formulir dengan benar)."
        )
      ])
    ])
  ])
